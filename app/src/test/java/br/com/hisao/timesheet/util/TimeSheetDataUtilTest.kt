...
class TimeSheetDataUtilTest {
    ...
    fun isConsistent() {
        ...
        var list = ArrayList<TimeSheetData>()
        list.add(t1)
        list.add(t2)
        list.add(t3)
    ...
    fun diffMinutesList() {
        ...
        var t5 = TimeSheetData(0, TimeSheetDataType.START.name, 1900, 1, 1, 3, 0)
        var t6 = TimeSheetData(0, TimeSheetDataType.STOP.name, 1900, 1, 1, 4, 0)
        list.clear()
        list.add(t1)
        list.add(t2)
        list.add(t3)
